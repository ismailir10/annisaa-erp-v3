...
describe("journal entry recovery", () => {
 it("shows picker recovery for missing params", () => { nav.params = new URLSearchParams(); vi.stubGlobal("fetch", vi.fn()); render(<Page />); expect(screen.getByText("Parameter tidak valid")).toBeInTheDocument(); });
