...
export async function PUT(
  ...
  await prisma.parent.update({
    ...
    data: {
      ...
      homeAddressLine: d.homeAddressLine !== undefined ? (d.homeAddressLine?.trim() || null) : undefined,
      homeVillageCode: d.homeVillageCode !== undefined ? (d.homeVillageCode?.trim() || null) : undefined,
      homeVillageName: d.homeVillageName !== undefined ? (d.homeVillageName?.trim() || null) : undefined,
      homeDistrictCode: d.homeDistrictCode !== undefined ? (d.homeDistrictCode?.trim() || null) : undefined,
      homeDistrictName: d.homeDistrictName !== undefined ? (d.homeDistrictName?.trim() || null) : undefined,
      homeRegencyCode: d.homeRegencyCode !== undefined ? (d.homeRegencyCode?.trim() || null) : undefined,
      homeRegencyName: d.homeRegencyName !== undefined ? (d.homeRegencyName?.trim() || null) : undefined,
      homeProvinceCode: d.homeProvinceCode !== undefined ? (d.homeProvinceCode?.trim() || null) : undefined,
      homeProvinceName: d.homeProvinceName !== undefined ? (d.homeProvinceName?.trim() || null) : undefined,
      employerAddressLine: d.employerAddressLine !== undefined ? (d.employerAddressLine?.trim() || null) : undefined,
      employerVillageCode: d.employerVillageCode !== undefined ? (d.employerVillageCode?.trim() || null) : undefined,
      employerVillageName: d.employerVillageName !== undefined ? (d.employerVillageName?.trim() || null) : undefined,
      employerDistrictCode: d.employerDistrictCode !== undefined ? (d.employerDistrictCode?.trim() || null) : undefined,
      employerDistrictName: d.employerDistrictName !== undefined ? (d.employerDistrictName?.trim() || null) : undefined,
      employerRegencyCode: d.employerRegencyCode !== undefined ? (d.employerRegencyCode?.trim() || null) : undefined,
      employerRegencyName: d.employerRegencyName !== undefined ? (d.employerRegencyName?.trim() || null) : undefined,
      employerProvinceCode: d.employerProvinceCode !== undefined ? (d.employerProvinceCode?.trim() || null) : undefined,
      employerProvinceName: d.employerProvinceName !== undefined ? (d.employerProvinceName?.trim() || null) : undefined,
    },
  });
