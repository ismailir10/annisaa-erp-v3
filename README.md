...
- **Teacher** — check-in/out, attendance calendar, Nilai Siswa (with live-announced pre-publish missing-score warning), Buku Penghubung (school scope), salary slip PDF + tenant-scoped in-app slip detail (`/teacher/slips/[id]`), profile.
