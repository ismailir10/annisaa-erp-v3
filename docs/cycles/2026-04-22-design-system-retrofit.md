...
- [ ] **A2. Overlays audit — admin** — enforce Dialog-desktop / Sheet-mobile for create-or-edit (via `useIsMobile()`), AlertDialog for destructive, no stacking, no `window.confirm()`, toast past-tense.
