...
- **Admin Polish — StatsCardsRow Migration (2026-04-23)**: 9 inline `grid grid-cols-2 lg:grid-cols-{3|4} gap-3 mb-6` stat rows across admin pages (guardians, admissions, payroll/[id], attendance, enrollments, assessments, student-attendance, student-journal/monitoring, assessments/templates) migrated to the shared `<StatsCardsRow cols={3|4}>` primitive extracted in the earlier admin UX polish cycle. Byte-identical DOM, just the shared seam. See [`docs/cycles/2026-04-23-admin-polish-stats-cards-row.md`](docs/cycles/2026-04-23-admin-polish-stats-cards-row.md)
