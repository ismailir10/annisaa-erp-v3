...
export async function POST(req: NextRequest) {
  ...
  const teacherEmails: Record<string, string> = {
    TKIT_A: "dyasnada.f@gmail.com",
    TKIT_B: "yohananuraeni30@gmail.com",
    KB_ASTER: "hamdashakia8@gmail.com",
    KB_METLAND: "elvriani.haziza@yahoo.com",
    DCARE: "sitinurfajariah90@gmail.com",
    POPUP: "rainbee9010@gmail.com",
  };
