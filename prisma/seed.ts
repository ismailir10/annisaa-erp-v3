...
async function main() {
  ...
  const teacherClassMap: { empKode: string; classKey: string; role: string }[] = [
    { empKode: "NNF6", classKey: "TKIT_A", role: "HOMEROOM" },   // Nurdyas - Walas A1
    { empKode: "YN7", classKey: "TKIT_B", role: "HOMEROOM" },    // Yohana - Walas A2
    { empKode: "NK20", classKey: "KB_ASTER", role: "HOMEROOM" },  // Nur Khamidah - Ka Paud
    { empKode: "EH21", classKey: "KB_METLAND", role: "HOMEROOM" },// Elvriani - Pj Dcare Metland
    { empKode: "SNF17", classKey: "DCARE", role: "HOMEROOM" },    // Siti Nur Fajariah - Walas Dcare
    { empKode: "HH3", classKey: "POPUP", role: "HOMEROOM" },      // Hana Hanifah - Ka Dcare
  ];
