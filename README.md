...
| Date | Decision | Why |
|---|---|---|
| 2026-05-18 | Kesiswaan CRUD parity (in flight): superset parent-option constants; Student photo + Parent KTP/KK admin-only auth-proxied uploads; Student-metadata editor; lifecycle "Riwayat Status" sub-card; Student create dialog full field set; Admission `campusPreference` end-to-end; unified `GuardianFormBody` across 3 entry points | Closes UU PDP 27/2022 compliance gap for ID/KK; eliminates 3-way guardian-form drift — see [cycle](docs/cycles/2026-05-18-kesiswaan-crud-audit.md) |
