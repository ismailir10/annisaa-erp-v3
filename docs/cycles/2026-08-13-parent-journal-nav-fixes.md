...
- [ ] **T4 — WeekGrid window support + parent wiring (depends on T2, T3)**
...
- [ ] **T5 — ~~Rename Capaian → Penilaian~~ → residual nav sub-label cleanup only (independent)** *(rescoped mid-cycle — see below)*
