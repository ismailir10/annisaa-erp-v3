...
- [ ] **T4 — API: indicator-theme-link idempotent toggle** *(depends T1)*
...
- [ ] **T5 — Admin page: `/admin/semesters/[id]/objectives` + indicator matrix UI + README bullet** *(depends T2, T3, T4)*
