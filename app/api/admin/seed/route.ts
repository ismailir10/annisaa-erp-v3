...
export async function POST(req: NextRequest) {
  ...
  const admissionDefs = [
    ...
    { childName: "Kenzo Alvaro", childAge: "4 tahun", childGender: "L", parentName: "Rina Alvaro", parentPhone: "081234500004", source: "REFERRAL", status: "VISITED", programCode: "KB", followUpDate: "2026-04-20" },
    { childName: "Nayla Safira", childAge: "5 tahun", childGender: "P", parentName: "Ahmad Safira", parentPhone: "081234500005", source: "WHATSAPP", status: "VISITED", programCode: "TKIT", followUpDate: "2026-04-22" },
