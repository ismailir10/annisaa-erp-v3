...
- **Teacher** — check-in/out, attendance calendar, Nilai Siswa (with live-announced pre-publish missing-score warning), Buku Penghubung (school scope), salary slip PDF, profile.
