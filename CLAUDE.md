...
```
app/{admin,teacher,parent}/  38 / 11 / 6 portal pages
app/api/                     149 routes (organized by domain)
...
e2e/                         18 specs (admin, admin-curriculum-objectives, admin-dashboard, admin-dialogs, admin-hydration, admin-school-admin, branding, curriculum-admin, curriculum-promes-import, daftar-public, design-system, parent, parent-attendance-scoping, parent-signout-bfcache, payment, perf-budget, sibling-detect, teacher)
