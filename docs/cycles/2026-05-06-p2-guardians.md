...
- T4 — `npx vitest run prisma/migration-tests/08-guardians.test.ts` ✓ **19 / 19** in 1.07s. `npm run build` ✓ (compiled in 3.2s). `npx vitest run` (full suite) ✓ **35 files, 869 passed | 4 skipped** (873 total).
