...
| 2026-05-12 | Private `admission-documents` Supabase Storage bucket; uploads/downloads via signed URLs only (deny-anon RLS); `lib/supabase/service-client.ts` singleton | Admission doc uploads (KTP Ayah/Ibu, KK) need presigned paths; direct anon reads blocked — see [cycle](docs/cycles/2026-05-12-admission-storage.md) |
