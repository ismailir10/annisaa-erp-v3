...
|---|---|---|---|
| `parent01@example.test` | Demo Parent (g_4) | Demo Child (st_4) | TKIT B |
| `parent02@example.test` | Demo Parent 02 | Demo Child | Unknown (no enrollment!) |
...
- [ ] `parent02@example.test` → dashboard shows "Demo Child" with class name (not null)
