...
| **students** | Student lifecycle: students, guardians (full 13-field edit + detail page), enrollments, admissions (admin CRM + public `/daftar` entry + sibling auto-detect on submit) |
