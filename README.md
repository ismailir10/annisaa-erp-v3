...
| Date | Decision | Why |
|---|---|---|
| 2026-05-18 | Kesiswaan CRUD parity (in flight): superset parent-option constants; Student photo + Parent KTP/KK auth-proxied uploads; Student-metadata editor; lifecycle "Riwayat Status"; Student create full field set; Admission `campusPreference` end-to-end; unified `GuardianFormBody`; race-safe `isPrimary`+`childOrder`; Student detail KK preview via primary guardian | Closes UU PDP 27/2022 gap for ID/KK; eliminates 3-way guardian-form drift; concurrent primary toggle race-safe — see [cycle](docs/cycles/2026-05-18-kesiswaan-crud-audit.md) |
